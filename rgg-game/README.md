...
Правила текущих игровых механик описаны в [GAME_MECHANICS.md](./GAME_MECHANICS.md).

## Контекст Проекта

Проект создан для друзей и не планируется для коммерческого использования.

Основной разработчик проекта - Android developer, не frontend-разработчик. Значительная часть frontend-кода, архитектурных решений и технического долга собиралась в формате vibe coding с помощью нейросетей: Codex и Gemini. Поэтому в проекте местами можно встретить смешение подходов, экспериментальные решения и участки, которые постепенно приводятся к более аккуратной структуре.

Цель проекта - рабочая, живая игра для своей компании, а не polished SaaS-продукт или коммерческая платформа.
